...

{
    public class AuthenticateService : IAuthenticateService
    {
        ...
        public AuthenticateService(IOptions<AppSettings> appSettings, NorthwindOriginalContext context)
        {
        ...
        public LoggedUser? Authenticate(string username, string password)
        {
            ...
            var foundUser = _context.Users.SingleOrDefault(x => x.Username == username && x.Password == password);
